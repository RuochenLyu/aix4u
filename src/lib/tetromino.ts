 ...
 * lifted out of its photo, Z is a transfer between two lines — and the skin and
 * the eye are designed against that one silhouette.
 *
...
export const SHAPES = {
  ...
  Z: shape([[0, 0], [1, 0], [1, 1], [2, 1]], 'horizontal step down, upper row shifted left'),
 ...
 * scenery — it draws from the whole bag. Every one of the seven has a product
 * now, so the two tables happen to coincide; they stay separate because they
